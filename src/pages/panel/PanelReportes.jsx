    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-4 flex flex-wrap items-end gap-3">
        ...
        <div className="flex gap-1">
          <button onClick={elegirHoy} className="px-3 py-2 rounded text-sm bg-slate-100 text-slate-600">
            Hoy
          </button>
          <button onClick={elegirSemana} className="px-3 py-2 rounded text-sm bg-slate-100 text-slate-600">
            Esta semana
          </button>
          <button onClick={elegirMes} className="px-3 py-2 rounded text-sm bg-slate-100 text-slate-600">
            Este mes
          </button>
        </div>
      </div>
